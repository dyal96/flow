...
![Dashboard Preview](https://github.com/dyal96/flow/demo/screenshot.jpg)
...
3.  **Setup:** The first time you open it, you'll be asked to set a password to secure your vault.
